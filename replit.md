...
├── refine_leads.py      # Data refinement pipeline (validation, scoring, two-CSV output)
├── templates/
...
├── leads.csv            # Raw output file (generated)
├── unit8_leads_enriched.csv  # Refined enriched leads (generated by refine_leads.py)
└── unit8_leads_excluded.csv  # Excluded leads with reasons (generated by refine_leads.py)
```
